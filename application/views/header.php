  ...
  <div class="container-fluid header-section w3l">
    ...
    <div class="navbar-header w3">
	 ...
	 <a class="navbar-brand logo w3-layouts" href="<?php echo base_url()?>">
	  ...
	  <img src="<?php echo base_url()?>assets/images/logo.png" alt="home" class="head w3l" style="height: 130px;margin-top:-21px" />
		...
		<li><a href="<?php echo base_url()?>contact">Contact Us</a></li>
				...
				<div class="w3ls-social-icons">
					<ul class="social-nav model-3d-0 footer-social w3_agile_social two" >
															...
															<li><a class="pinterest" href="https://api.whatsapp.com/send?phone=916363716384&text=Hello">
  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active" align="center">
        <img src="<?php echo base_url()?>assets/images/slides/Home1.jpg"  alt="..." style='width:1200px;height: 450px;'>
      ...
      <div class="item" align="center">
        <img src="<?php echo base_url()?>assets/images/slides/Home2.jpg" alt="..."  style='width:1200px;height: 450px;'>
        <!-- <div class="carousel-caption d-none d-md-block">
      ...
      <div class="item" align="center">
        <img src="<?php echo base_url()?>assets/images/slides/Home3.jpg" alt="..." style='width:1200px;height: 450px;'>
        <!-- <div class="carousel-caption d-none d-md-block">
			<h3 style="color:#ff0066;font-size: 48px;"><b>“Don’t tell people your dreams. Show them”</b></h3>
        </div> -->
      </div>
       <div class="item" align="center">
        <img src="<?php echo base_url()?>assets/images/slides/Home4.jpg" alt="..." style='width:1200px;height: 450px;'>
      </div>
       <div class="item" align="center">
        <img src="<?php echo base_url()?>assets/images/slides/Home5.jpg" alt="..." style='width:1200px;height: 450px;'>
      </div>
       <div class="item" align="center">
        <img src="<?php echo base_url()?>assets/images/slides/Home6.jpg" alt="..." style='width:1200px;height: 450px;'>
      </div>
       ...
       <div class="item" align="center">
        <img src="<?php echo base_url()?>assets/images/slides/Home8.jpg" alt="..." style='width:1200px;height: 450px;'>
      </div>
    </div>
